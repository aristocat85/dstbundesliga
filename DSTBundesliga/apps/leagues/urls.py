...
urlpatterns = [
    ...
    path(
        "conf/<str:conference>/lev/<int:level>/",
        views.level_detail,
        name="conference-detail",
    ),
    path(
        "conf/<str:conference>/lev/<int:level>/reg/<str:region>/",
        views.level_detail,
        name="region-detail",
    ),
    ...
    path(
        "stats/facts_and_figures/<str:league_id>/",
        views.facts_and_figures_for_league,
        name="facts_and_figures_league",
    ),
